...
class CI_Email {
	...
	var	$smtp_host		= "smtp.insanius.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "noreply@insanius.com";		// SMTP Username
	var	$smtp_pass		= "kamikaze";		// SMTP Password
